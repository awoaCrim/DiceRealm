...
const fixedDndOutputContract = [
  ...
  '剧情长度：必须遵循当前预设或系统规则中声明的硬上限；超过上限属于格式错误。若未另行指定，默认 objectiveLog 最多 300 个中文字符、publicLog 最多 300 个中文字符、privateUpdatesByPlayer 每名玩家最多 150 个中文字符。信息量少时可以更短，不要填充内容。',
