...
function buildDndOutputContract(limits: NarrativeLengthLimits): string {
  ...
  '叙事人称：objectiveLog 和 publicLog 默认使用第三人称或客观陈述，例如“赛琳检查洞口”“队伍听见水滴声”；不要把公开/客观剧情默认写成“你们……”。只有 NPC 台词、引用玩家原话或自然对话中才保留“你/你们”。privateUpdatesByPlayer 默认使用第二人称，例如“你发现……”“你听见……”，不要写成第三人称旁白。',
